...
/**
 * The retired Mikian.Photos hub (2026-09-03). This WAS the site root: a short
 * hero plus a directory of the current PUBLIC events (each linking to
 * /e/[slug]). The root now belongs to the Rowtember landing page; the photo
 * marketplace itself is untouched and still fully reachable — event pages
 * at /e/[slug], orders, admin, the lot — this hub just moved here, unlinked,
 * so nothing is lost when the storefront comes back.
 *
